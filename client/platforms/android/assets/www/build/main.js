...
var WaitPage = (function () {
    function WaitPage(navCtrl, alertCtrl, geolocation) {
        this.navCtrl = navCtrl;
    ...
    WaitPage.prototype.confirmEmergency = function () {
        ...
        console.log("HELLO");
        this.geolocation.getCurrentPosition().then(function (resp) {
            document.getElementById("info").innerText = resp.coords.longitude + "," + resp.coords.latitude;
        }).catch(function (error) {
...
WaitPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_geolocation__["a" /* Geolocation */]])
], WaitPage);
