...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__accountSettings_accountSettings__ = __webpack_require__(207);
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        _d = (_c = console).log;
                        return [4 /*yield*/, this.storage.set("phoneNumber", __WEBPACK_IMPORTED_MODULE_4__env__["a" /* BEN_NUMBER */])];
                    case 2:
                        // console.log(Config.get("projectName"));
                        _d.apply(_c, [_e.sent()]);
                        return [2 /*return*/];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__env__ = __webpack_require__(206);
...
var WaitPage = (function () {
    function WaitPage(navCtrl, alertCtrl, storage, geolocation, http, uniqueDeviceID, sms) {
        this.navCtrl = navCtrl;
        this.alertCtrl = alertCtrl;
        this.storage = storage;
        this.geolocation = geolocation;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        if (this.isSMS) {
                            this.sms.send(__WEBPACK_IMPORTED_MODULE_6__env__["b" /* TWILLIO_NUMBER */], "address\n" + deviceID + "\n" + this.address + "\n" + this.zipcode, { replaceLineBreaks: true });
                        }
                        else {
                            console.log("HELLO");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        if (this.isSMS) {
                            this.sms.send(__WEBPACK_IMPORTED_MODULE_6__env__["b" /* TWILLIO_NUMBER */], "end\n" + deviceID, { replaceLineBreaks: true });
                        }
                        else {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return TWILLIO_NUMBER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BEN_NUMBER; });
var TWILLIO_NUMBER = "6178299064";
var BEN_NUMBER = "8576361412";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_accountSettings_accountSettings__ = __webpack_require__(207);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_map_map__ = __webpack_require__(208);
